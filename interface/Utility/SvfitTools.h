...
class MCTauTauQuantitiesAdapter : public classic_svFit::DiTauSystemHistogramAdapter
{
...
public:
	...
	ClassicSVfit GetSvfitAlgorithm(int verbosity, SvfitEventKey const& svfitEventKey, bool addLogM) const;

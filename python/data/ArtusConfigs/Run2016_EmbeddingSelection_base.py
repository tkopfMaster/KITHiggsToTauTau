...
def build_config(nickname):
  ...
  config["Pipelines"] += importlib.import_module("HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2016_EmbeddingSelection.mm").build_config(nickname)
  config["Pipelines"] += importlib.import_module("HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2016_EmbeddingSelection.mm_ss").build_config(nickname)

...
def build_config(nickname):
  ...
  config["MuonID"] = mediumHIPsafe2016 if re.match("(Run|Embedding)2016(B|C|D|E|F)|Spring16", nickname) else "medium"
  
  config["MuonIsoTypeUserMode"] = "fromcmsswr04" if re.match("(Spring16|Summer16|Run2016|Embedding2016)", nickname) else "fromcmssw"

...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["ztommfakes"] = "Z + jets fakes"
			...
			self.labels_dict["ttbartotttomm"] = "t#bar{t} #rightarrow #tau#tau #rightarrow #mu#mu#nu#nu"
			self.labels_dict["ttbartommfakes"] = "t#bar{t} + jets fakes"
			...
			self.labels_dict["ewkt"] = "Electroweak (V#rightarrow#tau)"
			self.labels_dict["ewkl"] = "Electroweak (l#tau)"
			self.labels_dict["ewkj"] = "Electroweak (jet#rightarrow#tau_{h})"
			self.labels_dict["emb"] = "#mu #rightarrow #tau embedded"
			self.labels_dict["qcd"] = "QCD"
			self.labels_dict["htt"] = "SM H(125 GeV) #times 100"
			self.labels_dict["ggh"] = "SUSY ggH(250 GeV) (100 pb)"
			self.labels_dict["bbh"] = "SUSY bbH(250 GeV) (100 pb)"
			...
			self.labels_dict["tt_d0_1"] = "Leading Tau dxy"
			self.labels_dict["tt_d0_2"] = "Trailing Tau dxy"
			self.labels_dict["tt_dZ_1"] = "Leading Tau dz"
			self.labels_dict["tt_dZ_2"] = "Trailing Tau dz"
			...
			self.labels_dict["tt_m_N"] = "Nostradamass m^{NN}_{#tau#tau} / GeV"
			...
			self.labels_dict["mt_d0_1"] = "Muon dxy"
			self.labels_dict["mt_d0_2"] = "Tau dxy"
			self.labels_dict["mt_dZ_1"] = "Muon dz"
			self.labels_dict["mt_dZ_2"] = "Tau dz"
			...
			self.labels_dict["mt_m_N"] = "Nostradamass m^{NN}_{#tau#tau} / GeV"
			...
			self.labels_dict["et_d0_1"] = "Electron dxy"
			self.labels_dict["et_d0_2"] = "Tau dxy"
			self.labels_dict["et_dZ_1"] = "Electron dz"
			self.labels_dict["et_dZ_2"] = "Tau dz"
			...
			self.labels_dict["et_m_N"] = "Nostradamass m^{NN}_{#tau#tau} / GeV"
			...
			self.labels_dict["em_d0_1"] = "Electron dxy"
			self.labels_dict["em_d0_2"] = "Muon dxy"
			self.labels_dict["em_dZ_1"] = "Electron dz"
			self.labels_dict["em_dZ_2"] = "Muon dz"
			...
			self.labels_dict["em_m_N"] = "Nostradamass m^{NN}_{#tau#tau} / GeV"

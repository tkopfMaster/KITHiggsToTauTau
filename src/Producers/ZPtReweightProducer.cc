...
void ZPtReweightProducer::Init(setting_type const& settings)
{
	...
	if (settings.GetDoZptUncertainties())
	{
		...
		//m_ZptWeightUncertaintiesFunktor["zPtWeightEsUp"] = m_workspace->function("zpt_weight_esup")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightEsDown"] = m_workspace->function("zpt_weight_esdown")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt0Up"] = m_workspace->function("zpt_weight_statpt0up")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt0Down"] = m_workspace->function("zpt_weight_statpt0down")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt40Up"] = m_workspace->function("zpt_weight_statpt40up")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt40Down"] = m_workspace->function("zpt_weight_statpt40down")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt80Up"] = m_workspace->function("zpt_weight_statpt80up")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightStatPt80Down"] = m_workspace->function("zpt_weight_statpt80down")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightTTbarUp"] = m_workspace->function("zpt_weight_ttup")->functor(m_workspace->argSet("z_gen_pt"));
		//m_ZptWeightUncertaintiesFunktor["zPtWeightTTbarDown"] = m_workspace->function("zpt_weight_ttdown")->functor(m_workspace->argSet("z_gen_pt"));
	}
